...
export const opencfp = endFormat.format(parseDate(current.timeline.cfp.open));
export const startDate = parseDate(current.start_date);
export const start = startFormat.format(startDate);
export const end = endFormat.format(parseDate(current.end_date));
