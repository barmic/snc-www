...
export const opencfp = endFormat.format(new Date(current.timeline.cfp.open));
export const startDate = new Date(current.start_date);
export const start = startFormat.format(startDate);
export const end = endFormat.format(new Date(current.end_date));
